...
namespace Connect.Testing.Koi
{
    ...
    public class TestKoi
    {
        ...
        //public readonly string ClassesOldString = $"{Bs3}:{Bs3Cls},{Bs4}:{Bs4Cls},{Fd6}:{Fd6Cls}";
        ...
        {
            var result2 = new Part(Bs3).Pick(ClassesString);
        ...
        {
            var result2 = new Part(Bs3).Pick(ClassesStringWithAll);
        ...
        {
            var result2 = new Part(Css.Unknown).Pick(ClassesStringWithAll);
        ...
        {
            var result2 = new Part(Unknown).Pick(ClassesStringWithoutUnknown);
        ...
        {
            var result2 = new Part(Unknown).Pick(ClassesStringNoUnknownWithAll);
        ...
        {
            var clsAttrib = new Part(Fd6).Class(ClassesString);
